...
export default function Round2() {
  ...
  const handleSubmit = () => {
    ...
    localStorage.setItem('totalScoreStep4_2', totalScore);
    localStorage.setItem('yearStep4_2', year);
    localStorage.setItem('monthStep4_2', month);
    localStorage.setItem('dayStep4_2', day);
    localStorage.setItem('weekdayStep4_2', weekday);
    localStorage.setItem('selectedWeatherStep4_2', select);
